...
[ExecuteInEditMode]
public class MeshBender2 : MonoBehaviour
{
    ...
    public void SetCurve(Curve curve, bool update = true)
    {
        if(this.curve != null) {
    ...
    private void Compute()
    {
        ...
        foreach (Vertex vert in vertices) {
            ...
            Quaternion q = Curve.GetRotationFromTangent(curveTangent) * Quaternion.Euler(0, -90, 0);
